                ...
                <div className="flex flex-col justify-between ml-2">
                    <div className="flex flex-row md:flex-col justify-between items-start my-0">
                        <div className="inline-flex items-center my-0">
                            ...
                            <h2 className="text-[35px] my-0 leading-none pt-1">{props.member.nom}</h2>
                        </div>

                        <h3 className="text-[25px] my-0 leading-none pt-3">{props.member.fonction}</h3>
                    </div>

                    <div className="inline-flex items-center my-0 pt-2">
                        <EmailIcon sx={{ color: "#FFAA00" }} />
                        <h3 className="text-sm text-gray-400 my-0 leading-none pl-1">{props.member.email}</h3>
                    </div>
                </div>
            </div>
        </>
